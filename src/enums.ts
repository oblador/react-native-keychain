...
export enum ERRORS {
  ...
  AUTH_USER_CANCEL = 'E_AUTH_USER_CANCEL',
  AUTH_UNKNOWN_ERROR = 'E_AUTH_UNKNOWN_ERROR',
  ...
  BIOMETRIC_ERROR = 'E_BIOMETRIC_ERROR',

  // Android errors
  ANDROID_SDK_NOT_SUPPORTED = 'E_ANDROID_SDK_NOT_SUPPORTED',
  ANDROID_KEY_INVALIDATED = 'E_ANDROID_KEY_INVALIDATED',
  ANDROID_USER_NOT_AUTHENTICATED = 'E_ANDROID_USER_NOT_AUTHENTICATED',

  // iOS errors
  IOS_INTERACTION_NOT_ALLOWED = 'E_IOS_INTERACTION_NOT_ALLOWED',
}
