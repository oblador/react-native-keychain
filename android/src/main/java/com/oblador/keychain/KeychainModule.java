...
import com.oblador.keychain.cipherStorage.CipherStorageKeystoreAesCbcBiom;
...
public class KeychainModule extends ReactContextBaseJavaModule {
    ...
    public @interface KnownCiphers {
        ...
        /**
         * AES encryption with biometric.
         */
        String AES_BIOM = "KeystoreAESCBCBiom";
        /**
         * Biometric + RSA.
         */
    ...
    public KeychainModule(@NonNull final ReactApplicationContext reactContext) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            addCipherStorageToMap(new CipherStorageKeystoreAesCbcBiom());
        }
    }
    ...
    protected void setGenericPassword(@NonNull final String alias,
        ...
        try {
            ...
            final EncryptionResult result = storage.encrypt(alias, username, password, level, handler);
    ...
    /* package */ void migrateCipherStorage(@NonNull final String service,
        ...
        final EncryptionResult encryptionResult = newCipherStorage.encrypt(
                ...
                decryptionResult.getSecurityLevel(), handler);
        ...
        public void onAuthenticationSucceeded(@NonNull final BiometricPrompt.AuthenticationResult result) {
            ...
            try {
                if (null != context) {
                    ...
                    byte[] encryptedUserName = cipher.update(usernameBytes);
